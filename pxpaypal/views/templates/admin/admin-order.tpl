...
<br/>
<fieldset>
    <legend><img src="{$module_dir}actions.gif" alt=""/> {l s='PayEx Payment actions' mod='pxpaypal'}</legend>
...
<br/>
<fieldset>
    <legend><img src="{$module_dir}information.png" alt=""/> {l s='PayEx transaction details' mod='pxpaypal'}</legend>
