...
class WywalletConfirmModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        $cancelUrl = _PS_BASE_URL_ . __PS_BASE_URI__ . 'index.php?fc=module&module=wywallet&controller=cancel&id_lang=' . $cart->id_lang . '&order_id=' . $this->module->currentOrder . '&token_order=' . md5(_COOKIE_KEY_ . 'orderId_' . $this->module->currentOrder) . '&key=' . $customer->secure_key;
