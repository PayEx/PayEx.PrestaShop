...
<br/>
<fieldset>
    <legend><img src="{$module_dir|escape:'htmlall':'UTF-8'}actions.gif" alt=""/> {l s='PayEx Payment actions' mod='bankdebit'}</legend>
    ...
    {if $transaction_status == '3'}
        <input type="button" id="process_capture" name="process_capture" value="{l s='Capture' mod='bankdebit'}"
               class="button"/>
        <input type="button" id="process_cancel" name="process_cancel" value="{l s='Cancel' mod='bankdebit'}"
               class="button"/>
    {/if}
    {if $transaction_status == '0' || $transaction_status == '6'}
        {l s='Refund' mod='bankdebit'}: <input type="text" id="refund_amount" name="refund_amount" value="{($order_amount)|floatval}" />
        <input type="button" id="process_refund" name="process_refund" value="{l s='Refund' mod='bankdebit'}"
               class="button"/>
    {/if}
    <br/>
</fieldset>
...
<br/>
<fieldset>
    <legend><img src="{$module_dir|escape:'htmlall':'UTF-8'}information.png" alt=""/> {l s='PayEx transaction details' mod='bankdebit'}</legend>
    ...
    <input type="button" id="process_fetch" name="process_fetch" value="{l s='Fetch Info' mod='bankdebit'}"
           class="button"/>
    <br/>
</fieldset>
