...
class Mobilepay extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        // Init Configuration
        $config = Configuration::getMultiple(array('PX_MP_ACCOUNT_NUMBER', 'PX_MP_ENCRYPTION_KEY', 'PX_MP_TESTMODE', 'PX_MP_TRANSACTION_TYPE'));
        $this->accountnumber = isset($config['PX_MP_ACCOUNT_NUMBER']) ? $config['PX_MP_ACCOUNT_NUMBER'] : '';
        $this->encryptionkey = isset($config['PX_MP_ENCRYPTION_KEY']) ? $config['PX_MP_ENCRYPTION_KEY'] : '';
        $this->mode = isset($config['PX_MP_TESTMODE']) ? $config['PX_MP_TESTMODE'] : 1;
        $this->transactiontype = isset($config['PX_MP_TRANSACTION_TYPE']) ? $config['PX_MP_TRANSACTION_TYPE'] : 'AUTHORIZATION';
        ...
        $this->displayName = $this->l('MobilePay Online');
        $this->description = $this->l('Accept payments for your products via MobilePay Online.');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('PX_MP_ACCOUNT_NUMBER', '');
        Configuration::updateValue('PX_MP_ENCRYPTION_KEY', '');
        Configuration::updateValue('PX_MP_TESTMODE', 1);
        Configuration::updateValue('PX_MP_TRANSACTION_TYPE', 'AUTHORIZATION');
        return true;
    }
    ...
    public function uninstall()
    {
        ...
        //Configuration::deleteByName('PX_MP_ACCOUNT_NUMBER');
        //Configuration::deleteByName('PX_MP_ENCRYPTION_KEY');
        //Configuration::deleteByName('PX_MP_TESTMODE');
        //Configuration::deleteByName('PX_MP_TRANSACTION_TYPE');
    ...
    {
        if (Tools::isSubmit('btnSubmit')) {
            Configuration::updateValue('PX_MP_ACCOUNT_NUMBER', Tools::getValue('accountnumber'));
            Configuration::updateValue('PX_MP_ENCRYPTION_KEY', Tools::getValue('encryptionkey'));
            Configuration::updateValue('PX_MP_TESTMODE', Tools::getValue('mode'));
            Configuration::updateValue('PX_MP_TRANSACTION_TYPE', Tools::getValue('transactiontype'));
        }
    ...
    {
        $this->_html .= '<img src="../modules/mobilepay/logo.png" style="float:left; margin-right:15px;" width="86" height="49"><b>'
            . $this->l('This module allows you to accept payments by MobilePay Online.') . '</b><br /><br />';
