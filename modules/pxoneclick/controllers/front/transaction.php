 ...
 * @since 1.5.0
 */
class PxoneclickTransactionModuleFrontController extends ModuleFrontController
{
    ...
    public function log($message, $order_id = null)
    {
        if (!$this->_log) {
            ...
            $this->_log->setFilename(_PS_ROOT_DIR_ . '/log/payex_tc.log');
        }
