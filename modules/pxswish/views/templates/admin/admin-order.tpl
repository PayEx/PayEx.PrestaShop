...
<fieldset>
    ...
    {if $transaction_status == '3'}
        <input type="button" id="process_capture" name="process_capture" value="{l s='Capture' mod='pxswish'}"
               class="button"/>
        <input type="button" id="process_cancel" name="process_cancel" value="{l s='Cancel' mod='pxswish'}"
               class="button"/>
    {/if}
    {if $transaction_status == '0' || $transaction_status == '6'}
        {l s='Refund' mod='pxswish'}: <input type="text" id="refund_amount" name="refund_amount" value="{($order_amount)|floatval}" />
        <input type="button" id="process_refund" name="process_refund" value="{l s='Refund' mod='pxswish'}"
               class="button"/>
    {/if}
    <br/>
</fieldset>
...
<fieldset>
    ...
    <input type="button" id="process_fetch" name="process_fetch" value="{l s='Fetch Info' mod='pxswish'}"
           class="button"/>
    <br/>
</fieldset>
