...
{else}
    ...
    <form action="{$link->getModuleLink('pxswish', 'confirm', [], true)|escape:'html'}" method="post">
        <p>
            <img src="{$this_path_px}pxswish.png" alt="{l s='PayEx' mod='pxswish'}" width="80" height="80" style="float:left; margin: 0px 10px 5px 0px;" />
        ...
        <p>
            ...
            {else}
                {l s='We allow the following currency to be sent via Swish:' mod='pxswish'}&nbsp;<b>{$currencies.0.name}</b>
        ...
        <p class="cart_navigation" id="cart_navigation">
            ...
            <a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="button_large">{l s='Other payment methods' mod='pxswish'}</a>
        </p>
    </form>
{/if}
