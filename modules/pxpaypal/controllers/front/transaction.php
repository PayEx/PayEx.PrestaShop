 ...
 * @since 1.5.0
 */
class PxpaypalTransactionModuleFrontController extends ModuleFrontController
{
    ...
    public function log($message, $order_id = null)
    {
        if (!$this->_log) {
            ...
            $this->_log->setFilename(_PS_ROOT_DIR_ . '/log/pxpaypal_tc.log');
        }
