...
$additional = $module->paymentview == 'PX' ? 'PAYMENTMENU=TRUE' : '';
if ($module->responsive) {
    ...
    if (in_array($module->paymentview, array('CREDITCARD', 'DIRECTDEBIT'))) {
...
$params = array(
    ...
    'externalID' => '',
    'returnUrl' => _PS_BASE_URL_ . __PS_BASE_URI__ . 'modules/payex/validation.php?id_cart=' . $cart->id,
