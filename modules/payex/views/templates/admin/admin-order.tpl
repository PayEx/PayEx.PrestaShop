...
<br/>
<fieldset>
    <legend><img src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/actions.gif" alt=""/> {l s='PayEx Payment actions' mod='payex'}</legend>
...
<br/>
<fieldset>
    <legend><img src="{$module_dir|escape:'htmlall':'UTF-8'}/views/img/information.png" alt=""/> {l s='PayEx transaction details' mod='payex'}</legend>
