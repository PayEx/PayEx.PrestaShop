...
<br/>
<fieldset>
    <legend><img src="{$module_dir}actions.gif" alt=""/> {l s='PayEx Payment actions' mod='wywallet'}</legend>
...
<br/>
<fieldset>
    <legend><img src="{$module_dir}information.png" alt=""/> {l s='PayEx transaction details' mod='wywallet'}</legend>
